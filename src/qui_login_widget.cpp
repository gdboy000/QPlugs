    ...
    , _ui(new Ui::CLoginWidget)
{
    ...
    connect(_ui->faceModeBtn,&QPushButton::clicked,this,&CLoginWidget::onFaceModeBtnClicked);
    connect(_ui->codeModeBtn,&QPushButton::clicked,this,&CLoginWidget::onCodeModeBtnClicked);
    //connect(_ui->closeBtn,&QPushButton::released,this,&CLoginWidget::onCloseBtnHover);
    // //缓存中心按钮样式
...
// void CLoginWidget::onCloseBtnHover() {
// //
// }
...
//     }
// }
void CLoginWidget::onFaceModeBtnClicked() {
    _exchangeMode(IM_FACE);
}

void CLoginWidget::onCodeModeBtnClicked(){
    _exchangeMode(IM_CODE);
}
// /**
//  * 动画影响阴影槽函数
...
void CLoginWidget::_exchangeMode(IdentifyMode mode) {
    if(mode != _identifyMode) {
        _identifyModeControlBtn[_identifyMode]->setStyleSheet(":!hover{border-top: 2px none black;"
            "border-right: 2px none black;"
            "border-left: 2px none black;"
            "border-bottom: 2px none;}"
            ":hover{border:2px;background-color: rgb(0, 0, 0);color: white;}");
        _identifyModeControlBtn[mode]->setStyleSheet(":!hover{border-top: 2px solid black;"
            "border-right: 2px solid black;"
            "border-left: 2px solid black;"
            "border-bottom: 2px solid rgb(192, 191, 188);"
            "background-color: rgb(255, 255, 255);}"
            ":hover{border:2px;background-color: rgb(0, 0, 0);color: white;}");
        _identifyModeWidget[_identifyMode]->hide();
        _identifyModeWidget[mode]->show();
        _identifyMode = mode;
    }

}

void CLoginWidget::_initModeDpd() {
    _identifyModeControlBtn.assign(IM_NONE,nullptr);
    _identifyModeWidget.assign(IM_NONE,nullptr);
    _identifyModeControlBtn[IM_FACE] = _ui->faceModeBtn;
    _identifyModeControlBtn[IM_CODE] = _ui->codeModeBtn;
    _identifyModeWidget[IM_FACE] = new CFaceIdentifyWidget(_ui->widget2_2);
    _identifyModeWidget[IM_CODE] = new CCodeIdentifyWidget(_ui->widget2_2);
    _ui->widget2_2->setLayout(new QVBoxLayout(_ui->widget2_2));
    _ui->widget2_2->layout()->addWidget(_identifyModeWidget[IM_FACE]);
    _ui->widget2_2->layout()->addWidget(_identifyModeWidget[IM_CODE]);
    _identifyModeWidget[IM_CODE]->hide();
    //默认模块显示
